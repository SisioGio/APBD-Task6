...
namespace TASK6
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = Emps.Where(e => e.Job == "Frontend programmer").Where(e => e.Salary > 1000);
            return result;
        }
        ...
        {
            IEnumerable<Emp> result = Emps.Where(e => e.Salary == (Emps.Max(i => i.Salary)));
            return result;
        }
        ...
        {
            List<Emp> newEmpList = new List<Emp> { new Emp
            {
                Ename = "Brak wartosci",
                Job = null,
            ...
            IEnumerable<object> result = Emps.Select(e => new { e.Ename, e.Job, e.HireDate }).Union(newEmpList.Select(n => new { n.Ename, n.Job, n.HireDate }));
        ...
        public static IEnumerable<object> Task11()
        {
            ...
            IEnumerable<object> result = from dept in Depts
                                         join emp in Emps on dept.Deptno equals emp.Deptno
                                         group dept by dept.Dname into grouped
                                         where grouped.Count() > 1
                                         select new { name = grouped.Key, numOfEmployees = grouped.Count() };
            //  select new
            //  {
            //      DeptName = dept.Dname
            //  }
